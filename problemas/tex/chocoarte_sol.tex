...
\item \textbf{Post-optimización con $x_3 \leq 8$ (método de Lemke).} Se añade la restricción con su holgura, $x_3 + h_4 = 8$, como nueva fila de la tabla óptima, con $h_4$ como variable básica. En la primera versión de la fila aparecen los coeficientes tal cual se escriben; a continuación se eliminan de ella las variables básicas ($x_3$) para expresarla en función de las no básicas:
...
Como $x_3 = 10 > 8$, resulta $h_4 = -2 < 0$: la base sigue cumpliendo el criterio de optimalidad pero deja de ser factible, exactamente la situación que resuelve el método de Lemke:
