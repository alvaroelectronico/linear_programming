...
s.a.:\\
5x_1 + 3x_2 + 5x_3 + 1x_4 \leq 100\\
1x_1 + 5x_2 + 3x_3 + 0x_4 = 80\\
0x_1 + 1x_2 + 1x_3 + 0x_4 \geq 20\\
...
Se conoce la tabla de una solución obtenida mediante la resolución del problema mediante el método de las dos fases

% \begin{center}
% \begin{tabular}{c|c|ccccccc|}
%  & $z$ & $x_1$ & $x_2$ & $x_3$ & $h_1$ & $h_3$ & $a_2$ & $a_3$\\ 
% Phase 1 & 4 & $-1/5$ & 0 & $2/5$ & 0 & -1 & $-6/5$ & 0 \\ 
% Phase 2 & -10000 & -250 & 0 & -100 & 0 & 0 & 0 & 0 \\ 
% \hline
% $h_1$ & 52  & $22/5$ & 0 & $16/5$ & 1 & 0 & $-3/5$ & 0\\ 
% $x_2$ & 16  & $1/5$ & 1 & $3/5$ & 0 & 0 & $1/5$ & 0\\ 
% $a_3$ & 4  & $-1/5$ & 0 & $2/5$ & 0 & -1 & $-1/5$ & 1\\ 
% \hline
% \end{tabular}
% \end{center}
...
\begin{comment}
Podemos preguntar sobre el V^B de la variable artificiales o su signo o su relación con la restricción...
\end{comment}
